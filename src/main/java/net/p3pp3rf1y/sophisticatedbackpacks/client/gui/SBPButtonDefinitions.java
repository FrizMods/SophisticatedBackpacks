...
public class SBPButtonDefinitions {
	...
	public static final ButtonDefinition.Toggle<CraftingRefillType> REFILL_CRAFTING_GRID = net.p3pp3rf1y.sophisticatedcore.client.gui.controls.ButtonDefinitions.createToggleButtonDefinition(
			Map.of(
					CraftingRefillType.DisableRefill, getButtonStateData(new UV(96, 80), SBPTranslationHelper.INSTANCE.translUpgradeButton("disable_refill_crafting_grid"), Dimension.SQUARE_16, new Position(1, 1)),
					CraftingRefillType.RefillFromStorage, getButtonStateData(new UV(112, 80), SBPTranslationHelper.INSTANCE.translUpgradeButton("refill_crafting_grid_from_storage"), Dimension.SQUARE_16, new Position(1, 1)),
					CraftingRefillType.RefillFromPlayer, getButtonStateData(new UV(128, 80), SBPTranslationHelper.INSTANCE.translUpgradeButton("refill_crafting_grid_from_player"), Dimension.SQUARE_16, new Position(1, 1)),
					CraftingRefillType.RefillFromPlayerThenStorage, getButtonStateData(new UV(144, 80), SBPTranslationHelper.INSTANCE.translUpgradeButton("refill_crafting_grid_from_player_then_storage"), Dimension.SQUARE_16, new Position(1, 1)),
					CraftingRefillType.RefillFromStorageThenPlayer, getButtonStateData(new UV(160, 80), SBPTranslationHelper.INSTANCE.translUpgradeButton("refill_crafting_grid_from_storage_then_player"), Dimension.SQUARE_16, new Position(1, 1))
			));
}
